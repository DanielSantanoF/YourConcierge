...
class WebSecurityConfiguration(
    ...
    override fun configure(http: HttpSecurity) {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET, "/comunityservices/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/comunityservices/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/comunityservices/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/comunityservices/**").hasRole("ADMIN")
